...
const fetchAppliedInternships = async (): Promise<InternshipCardProps[]> => {
  // TODO: Replace this with your API call to fetch applied internships
  return [
    {
        id: 1,
...
export default async function StudentDashboard() {
  const appliedInternships = await fetchAppliedInternships();
      ...
      <div className="p-6 mt-24 lg:ml-64 space-y-6">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-4 bg-white dark:bg-[#1A2234] rounded-lg shadow">
            <h2 className="font-semibold text-lg dark:text-white mb-3">Profile Progress</h2>
        ...
        <div className="p-4 bg-white dark:bg-[#1A2234] rounded-lg shadow">
          ...
          {appliedInternships.length === 0 ? (
            <p className="text-gray-500 dark:text-gray-400">No internships applied yet.</p>
          ) : (
